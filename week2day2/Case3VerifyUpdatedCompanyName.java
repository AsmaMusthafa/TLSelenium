...
public class Case3VerifyUpdatedCompanyName {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("(//input[contains(@name,'company')])[2]")).sendKeys("Company 3");


		//Attribute based xPath://tagName[@attributeName='attributeValue']
		String firstName = "Swiggy";
		...
		if(updatedCompanyName.contains(changeCompanyName))
			System.out.println("Company Name has changed successfully");
		else
